...
from src.Data_quality_and_anomaly_detection.componenets.data_ingestion import DataIngestion
...
class DataPreprocessing:
    def __init__(self, output_path: str):
        self.dataingetsion = DataIngestion()
    ...
    def convert_excel_to_csv(self)-> str:
        try:
            ...
            excel_file = self.dataingetsion.initiate_ingestion()
